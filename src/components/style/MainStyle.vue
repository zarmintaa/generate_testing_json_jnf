...
.table-primary {
  --bs-table-color: #000;
  --bs-table-bg: rgb(210, 219.4, 240.6);
  --bs-table-border-color: rgb(168, 175.52, 192.48);
  --bs-table-striped-bg: rgb(199.5, 208.43, 228.57);
  --bs-table-striped-color: #000;
  --bs-table-active-bg: rgb(189, 197.46, 216.54);
  --bs-table-active-color: #fff;
  --bs-table-hover-bg: rgb(194.25, 202.945, 222.555);
...
.table-secondary {
  --bs-table-color: #000;
  --bs-table-bg: rgb(209.2, 234.2, 253);
  --bs-table-border-color: rgb(167.36, 187.36, 202.4);
  --bs-table-striped-bg: rgb(198.74, 222.49, 240.35);
  --bs-table-striped-color: #000;
  --bs-table-active-bg: rgb(188.28, 210.78, 227.7);
  --bs-table-active-color: #000;
  --bs-table-hover-bg: rgb(193.51, 216.635, 234.025);
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.table-success {
  --bs-table-color: #000;
  --bs-table-bg: rgb(215.4, 244.6, 229.4);
  --bs-table-border-color: rgb(172.32, 195.68, 183.52);
  --bs-table-striped-bg: rgb(204.63, 232.37, 217.93);
  --bs-table-striped-color: #000;
  --bs-table-active-bg: rgb(193.86, 220.14, 206.46);
  --bs-table-active-color: #000;
  --bs-table-hover-bg: rgb(199.245, 226.255, 212.195);
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.table-info {
  --bs-table-color: #000;
  --bs-table-bg: rgb(206.2, 239.6, 254.2);
  --bs-table-border-color: rgb(164.96, 191.68, 203.36);
  --bs-table-striped-bg: rgb(195.89, 227.62, 241.49);
  --bs-table-striped-color: #000;
  --bs-table-active-bg: rgb(185.58, 215.64, 228.78);
  --bs-table-active-color: #000;
  --bs-table-hover-bg: rgb(190.735, 221.63, 235.135);
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.table-warning {
  --bs-table-color: #000;
  --bs-table-bg: rgb(254.6, 244.2, 207);
  --bs-table-border-color: rgb(203.68, 195.36, 165.6);
  --bs-table-striped-bg: rgb(241.87, 231.99, 196.65);
  --bs-table-striped-color: #000;
  --bs-table-active-bg: rgb(229.14, 219.78, 186.3);
  --bs-table-active-color: #000;
  --bs-table-hover-bg: rgb(235.505, 225.885, 191.475);
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.table-danger {
  --bs-table-color: #000;
  --bs-table-bg: rgb(254.4, 219, 225.6);
  --bs-table-border-color: rgb(203.52, 175.2, 180.48);
  --bs-table-striped-bg: rgb(241.68, 208.05, 214.32);
  --bs-table-striped-color: #000;
  --bs-table-active-bg: rgb(228.96, 197.1, 203.04);
  --bs-table-active-color: #000;
  --bs-table-hover-bg: rgb(235.32, 202.575, 208.68);
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.table-light {
  --bs-table-color: #000;
  --bs-table-bg: #f6f8fb;
  --bs-table-border-color: rgb(196.8, 198.4, 200.8);
  --bs-table-striped-bg: rgb(233.7, 235.6, 238.45);
  --bs-table-striped-color: #000;
  --bs-table-active-bg: rgb(221.4, 223.2, 225.9);
  --bs-table-active-color: #000;
  --bs-table-hover-bg: rgb(227.55, 229.4, 232.175);
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.table-dark {
  --bs-table-color: #fff;
  --bs-table-bg: #11142d;
  --bs-table-border-color: rgb(64.6, 67, 87);
  --bs-table-striped-bg: rgb(28.9, 31.75, 55.5);
  --bs-table-striped-color: #fff;
  --bs-table-active-bg: rgb(40.8, 43.5, 66);
  --bs-table-active-color: #fff;
  --bs-table-hover-bg: rgb(34.85, 37.625, 60.75);
...
.form-control:focus {
  color: #777e89;
  background-color: transparent;
  border-color: rgb(142.5, 166, 219);
  outline: 0;
  box-shadow:
    var(--bs-box-shadow-inset),
    0 0 0 0.25rem rgba(30, 77, 183, 0.25);
}
...
[data-bs-theme="dark"] .form-select {
  --bs-form-select-bg-img: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23f1f9ff' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e");
}
...
.form-check-input:focus {
  border-color: rgb(142.5, 166, 219);
  outline: 0;
  box-shadow: 0 0 0 0.25rem rgba(30, 77, 183, 0.25);
}
...
.form-switch .form-check-input:focus {
  --bs-form-switch-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='rgb%28142.5, 166, 219%29'/%3e%3c/svg%3e");
}
...
.form-range::-webkit-slider-thumb:active {
  background-color: rgb(187.5, 201.6, 233.4);
}
...
.btn-primary {
  ...
  --bs-btn-hover-bg: rgb(25.5, 65.45, 155.55);
  --bs-btn-hover-border-color: rgb(24, 61.6, 146.4);
  --bs-btn-focus-shadow-rgb: 64, 104, 194;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: rgb(24, 61.6, 146.4);
  --bs-btn-active-border-color: rgb(22.5, 57.75, 137.25);
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
  --bs-btn-disabled-bg: #1e4db7;
  --bs-btn-disabled-border-color: #1e4db7;
}
...
.btn-secondary {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: rgb(22.1, 128.35, 208.25);
  --bs-btn-hover-border-color: rgb(20.8, 120.8, 196);
  --bs-btn-focus-shadow-rgb: 60, 167, 247;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: rgb(20.8, 120.8, 196);
  --bs-btn-active-border-color: rgb(19.5, 113.25, 183.75);
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.btn-success {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: rgb(48.45, 172.55, 107.95);
  --bs-btn-hover-border-color: rgb(45.6, 162.4, 101.6);
  --bs-btn-focus-shadow-rgb: 87, 211, 146;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: rgb(45.6, 162.4, 101.6);
  --bs-btn-active-border-color: rgb(42.75, 152.25, 95.25);
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.btn-info {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: rgb(9.35, 151.3, 213.35);
  --bs-btn-hover-border-color: rgb(8.8, 142.4, 200.8);
  --bs-btn-focus-shadow-rgb: 48, 190, 252;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: rgb(8.8, 142.4, 200.8);
  --bs-btn-active-border-color: rgb(8.25, 133.5, 188.25);
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.btn-warning {
  ...
  --bs-btn-hover-bg: rgb(253.3, 209.1, 51);
  --bs-btn-hover-border-color: rgb(253.2, 206.4, 39);
  --bs-btn-focus-shadow-rgb: 215, 171, 13;
  --bs-btn-active-color: #000;
  --bs-btn-active-bg: rgb(253.4, 211.8, 63);
  --bs-btn-active-border-color: rgb(253.2, 206.4, 39);
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
...
.btn-danger {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: rgb(214.2, 63.75, 91.8);
  --bs-btn-hover-border-color: rgb(201.6, 60, 86.4);
  --bs-btn-focus-shadow-rgb: 252, 102, 130;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: rgb(201.6, 60, 86.4);
  --bs-btn-active-border-color: rgb(189, 56.25, 81);
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.btn-light {
  ...
  --bs-btn-hover-color: #000;
  --bs-btn-hover-bg: rgb(209.1, 210.8, 213.35);
  --bs-btn-hover-border-color: rgb(196.8, 198.4, 200.8);
  --bs-btn-focus-shadow-rgb: 209, 211, 213;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: rgb(196.8, 198.4, 200.8);
  --bs-btn-active-border-color: rgb(184.5, 186, 188.25);
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #000;
...
.btn-dark {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: rgb(52.7, 55.25, 76.5);
  --bs-btn-hover-border-color: rgb(40.8, 43.5, 66);
  --bs-btn-focus-shadow-rgb: 53, 55, 77;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: rgb(64.6, 67, 87);
  --bs-btn-active-border-color: rgb(40.8, 43.5, 66);
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.btn-muted {
  ...
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: rgb(101.15, 107.1, 116.45);
  --bs-btn-hover-border-color: rgb(95.2, 100.8, 109.6);
  --bs-btn-focus-shadow-rgb: 139, 145, 155;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: rgb(95.2, 100.8, 109.6);
  --bs-btn-active-border-color: rgb(89.25, 94.5, 102.75);
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.btn-outline-primary {
  ...
  --bs-btn-border-color: #1e4db7;
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #1e4db7;
  --bs-btn-hover-border-color: #1e4db7;
  --bs-btn-focus-shadow-rgb: 30, 77, 183;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #1e4db7;
  --bs-btn-active-border-color: #1e4db7;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #1e4db7;
...
.nav-pills {
  ...
  --bs-nav-pills-link-active-bg: #1e4db7;
}
.nav-pills .nav-link {
...
.accordion {
  ...
  --bs-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%2367757c' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='M2 5L8 11L14 5'/%3e%3c/svg%3e");
  --bs-accordion-btn-icon-width: 1.25rem;
  --bs-accordion-btn-icon-transform: rotate(-180deg);
  --bs-accordion-btn-icon-transition: transform 0.2s ease-in-out;
  --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='shade-color%28%231e4db7, 60%%29' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='M2 5L8 11L14 5'/%3e%3c/svg%3e");
  --bs-accordion-btn-focus-box-shadow: 0 0 0 0.25rem rgba(30, 77, 183, 0.25);
...
[data-bs-theme="dark"] .accordion-button::after {
  --bs-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='rgb%28120, 148.2, 211.8%29'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
  --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='rgb%28120, 148.2, 211.8%29'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
}
...
.pagination {
  ...
  --bs-pagination-focus-box-shadow: 0 0 0 0.25rem rgba(30, 77, 183, 0.25);
...
.list-group {
  ...
  --bs-list-group-active-bg: #1e4db7;
  --bs-list-group-active-border-color: #1e4db7;
  display: flex;
  flex-direction: column;
  padding-left: 0;
  margin-bottom: 0;
...
.btn-close {
  ...
  --bs-btn-close-focus-shadow: 0 0 0 0.25rem rgba(30, 77, 183, 0.25);
...
.link-primary:hover,
.link-primary:focus {
  color: RGBA(24, 62, 146, var(--bs-link-opacity, 1)) !important;
  text-decoration-color: RGBA(
    24,
    62,
    146,
...
@media (min-width: 1200px) {
  #main-wrapper[data-layout="vertical"][data-header-position="fixed"][data-sidebartype="mini-sidebar"]
    .app-header {
    width: 100%;
  }
  #main-wrapper[data-layout="vertical"][data-header-position="fixed"]
...
@media (max-width: 1199px) {
  ...
  #main-wrapper[data-layout="vertical"][data-sidebartype="mini-sidebar"].show-sidebar
    .left-sidebar,
  #main-wrapper[data-layout="vertical"][data-sidebartype="full"].show-sidebar
    .left-sidebar {
    left: 0;
